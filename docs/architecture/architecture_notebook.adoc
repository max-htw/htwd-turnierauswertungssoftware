...
- Die Anwendung verwendet eine Client-Server-Architektur. Da maximal 200 Nutzer gleichzeitig erwartet werden, ist keine Lastverteilung oder zusätzliche Skalierung erforderlich. Ein einzelner Webserver genügt.
