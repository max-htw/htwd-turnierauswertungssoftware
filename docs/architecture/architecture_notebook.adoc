...
. Für die Entwicklung im Front-End wird https://nuxt.com/[Nuxt] benutzt. Dies vereinfacht die Nutzung von API's und bietet ein Übersichtliches Routing-System an.
