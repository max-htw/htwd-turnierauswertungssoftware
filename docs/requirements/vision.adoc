...
| Efassung der Turnierergebnisse| Hoch | Speichern der Ergebnisse -lokal wenn kein Netz verfügbar ist- und Synchronisierung bei Netzverfügbarkeit | Version 1.0
...
| Wiederverwendbarkeit | Mittel | Für jedes zukü nftige Jahr soll ein neues Turnier erstellt werden können | Version 1.0 
|===
