...
=== Referenzen
https://miro.com/welcomeonboard/QUpMOEdhN01VdDRyVUdlVlgzNXNxdkM0OUlSc1dnSU9EdjJBVVo4UlNzN2xIWnkzSGNXeFNJc28zYVRScm5Hd3wzNDU4NzY0NjA1MzU4MTU0MzQ5fDI=?share_link_id=268593339366
...
| Zuständig für die Funktionalität.
...
| Teamnamen sollten vor Ort zu Begin geändert werden können. Bsp: S1 = "Füchse" | Hoch | Version 1.4
...
| Erfassung der Ergebnisse in Excel | Mittel | Version1.2
...
| Legende einfügen, welche anzeigt, welches Team spielt und welches Team Schiedrichter ist |Mittel | version 1.4
...
| Die letzten 5 Turniere sollen in der Historie ersichtbar sein | Niedrig | Version 1.4
|===
