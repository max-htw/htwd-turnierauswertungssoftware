...
* Die Software muss mit allen aktuellen Betriebssystemen (Windows, MacOS, Linux, iOS, Android) auf Mobil- und Desktopgeräten in aktuellen Browsern (Chrome, Safari, Edge, Firefox, Opera etc.) funktionieren.
